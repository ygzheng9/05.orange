...
layui.define(["element", "jquery"], function (exports) {
    ...
    var miniPage = {
        ...
        renderPageTitle: function (href, options) {
            ...
            var pageTitleHtml =
                '<a lay-href="" href="javascript:;" class="layuimini-back-home">' +
                options.homeInfo.title +
                '</a><span lay-separator="">/</span>\n';
            var pageTitleArray = miniPage.buildPageTitleArray(
                href,
                options.menuList
            );
            ...
            if (pageTitleArray.length > 0) {
                for (var key in pageTitleArray) {
                    ...
                    if (key !== pageTitleArray.length - 1) {
                        ...
                        pageTitleHtml +=
                            "<a><cite>" + pageTitleArray[key] + "</cite></a>\n";
                    }
                }
            } else {
         ...
         * @param href
         * @returns {string}
         * 2020-04-06: 这里是同步的，修改成异步的
         */
        // added: 2020-04-06 zhengyg, 修改为异步，使用时 .done(html => {});
                ...
                if ($(this).attr("layuimini-href") === tabId) {
                    ...
                    var addMenuClass = function ($element, type) {
                        if (type === 1) {
                            ...
                            if (
                                $element.hasClass("layui-nav-item") &&
                                $element.hasClass("layui-this")
                            ) {
                                $(".layuimini-header-menu li").attr(
                                    "class",
                                    "layui-nav-item"
                                );
                            } else {
                            ...
                            if (
                                $element.hasClass("layui-nav-item") &&
                                $element.hasClass("layui-nav-itemed")
                            ) {
                                $(".layuimini-header-menu li").attr(
                                    "class",
                                    "layui-nav-item"
                    ...
                    var addMenuClass = function ($element, type) {
                        if (type === 1) {
                            ...
                            if (
                                ...
                                $("#" + moduleId + "HeaderId").addClass(
                                    "layui-this"
                                );
                                $(
                                    ".layuimini-menu-left .layui-nav.layui-nav-tree"
                                ).attr(
                                    "class",
        ...
        listenHash: function (options) {
            ...
            window.onhashchange = function () {
                ...
                if (
                    $(".layuimini-menu-left").attr("layuimini-page-add") ===
                    "yes"
                ) {
